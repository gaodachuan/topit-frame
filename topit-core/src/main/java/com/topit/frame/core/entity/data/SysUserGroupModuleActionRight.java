...
*/ 
@Entity
@Table(name="sys_user_group_module_action_right")
public class SysUserGroupModuleActionRight implements Serializable {
	...
	*/ 
	...
	public SysUserGroupModuleActionRight(){
		
	}
	
	public SysUserGroupModuleActionRight(int groupId, int moduleId,

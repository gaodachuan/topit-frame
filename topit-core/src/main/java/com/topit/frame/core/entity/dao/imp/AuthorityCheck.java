...
public class AuthorityCheck extends  HqlUtil implements IAuthorityCheck {
	...
	/**   
	 * <p>Title: check</p>   
	 * <p>Description: 通过传入用户id和对应的控制器类名、方法名判断用户是否具有该操作权限</p>   
	 * @param userid   用户id
	 * @param controllerClassName 控制器类名
	 * @param actionFunctionName  控制器的方法名
	 * @return
	 * @throws Exception   
	 * @see com.topit.frame.core.entity.dao.base.IAuthorityCheck#check(int, java.lang.String, java.lang.String)   
	 */
	...
	public boolean check(int userid, String controllerClassName,
		...
		String hql = "FROM SysUserUserGroup a,SysUserGroup b,SysUserGroupModuleActionRight c,SysModuleAction d"
		...
		query.setParameter("userid", userid).setParameter("controllerClassName", controllerClassName).setParameter("actionFunctionName", actionFunctionName);
